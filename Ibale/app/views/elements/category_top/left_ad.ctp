...
<div class="ad" id="leftAd<?php echo $key;?>">
    ...
    <p>
        ...
        <?php echo $appForm->file("{$pageSettingType}.left_ad.{$key}.file", array('name'=>'filename', 'size'=>'8', 'onchange'=>"javaScript:ajaxUploadImg(this, '".UPLOAD_PIC_ROOT.DS.splitWordsWithUnderLine($pageSettingType)."/{$id}/left_ad/', '200', '80', 'pLeftAd{$key}', 'leftAdPath{$key}');"));?>
