<?php $picUrl = (!empty($productInfo['product_pic_url']))?OMS_API_PHOTO_ROOT_URL.$productInfo['product_pic_url']:'/image/front/none_90.jpg';?>
    <p class="imgCenter">
        <a href="<?php echo HTTP_HOME_PAGE_URL;?>/product/detail/product_cd:<?php echo $productInfo['product_cd'];?><?php if (!empty($giftFlg)):?>/gift_flg:true<?php endif;?>" title="<?php echo $productInfo['product_name'];?>"><img src="<?php echo $picUrl;?>" width="175" height="100" /> </a>
    </p>
    <p class="productName">
    ...
    <?php endif;?>
     <br>
        <span class="bluetxt">销量：<em><?php echo $productInfo['sold_number'];?></em>
        <a href="<?php echo HTTP_HOME_PAGE_URL;?>/product/detail/product_cd:<?php echo $productInfo['product_cd'];?>/selected:estimation#tab">(<?php echo !empty($productInfo['estimatino_count'])?$productInfo['estimatino_count']:'0';?>人评论)</a></span>
