-function() {
  ...
  style : "position:absolute;z-index:1000000001;display:none;overflow:auto;"
 }), div1 = creElm( {
  style : "position:fixed;z-index:1000000000;display:none;top:80%;left:50%;overflow:auto;"
 }), iframe = creElm(
   {
 ...
 for ( var i = 0, ci, tmp; ci = h[i++];) {
  ...
  if (ci.className
   ...
   ci.onclick = function(a) {
    return function() {
        if ($(this).parent().attr('shareto').length != 0) {
            sharedURL = $(this).parent().attr('shareto');
            share_to(a, sharedURL);
        } else {
            share_to(a);
        }
    }
...
function share_to(m, sharedURL) {
  ...
  window
    .open('http://cang.baidu.com/do/add?it='
      ...
      + '&iu=' + encodeURIComponent(sharedURL)
      + '&fr=ien#nw=1', 'baidu',
  ...
  void ((function(s, d, e) {
   ...
   var f = 'http://v.t.sina.com.cn/share/share.php?', u = sharedURL, p = [
...
//   'url' : url,
//   'title' : url == sharedURL ? document.title : null
//  });
...
//      + (screen.height - 500) / 2);
  ...
  var kw = window
    .open(
      '',
      'kaixin001',
      'toolbar=no,titlebar=no,status=no,menubar=no,scrollbars=no,location:no,directories:no,width=570,height=550,left='
        + (screen.width - 570)
        / 2
        + ',top='
        + (screen.height - 420) / 2);
  ...
  window.open("http://share.jianghu.taobao.com/share/addShare.htm?url="
    + encodeURIComponent(sharedURL), 'taojianghu',
    'toolbar=0,status=0,width=550,height=400,left='
      + (screen.width - 550) / 2 + ',top='
      + (screen.height - 500) / 2);
 } else if (m == "gmail") {
  ...
  window
    .open('http://leshou.com/post?act=shou&reuser=&url='
      + encodeURIComponent(sharedURL) + '&title='
  ...
  window.open(
    "http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url="
      + encodeURIComponent(sharedURL), 'qzone',
  ...
  var itieba_share = 'http://tieba.baidu.com/i/sys/share?link='
    + encodeURIComponent(sharedURL) + '&type='
  ...
  window.open("http://mail.live.com/secure/start?action=compose&subject="
    ...
    + encodeURIComponent(sharedURL), 'hotmail',
  ...
  window.open("http://digg.com/submit?type=0&url="
    + encodeURIComponent(sharedURL), 'digg',
  ...
  window
    .open(
      'http://apps.hi.baidu.com/share/?url=' + encodeURIComponent(sharedURL)+ '&title='
      + encodeURIComponent(document.title),
      'baiduhi',
  ...
  window.open('http://www.139.com/share/share.php?title='
    ...
    + encodeURIComponent(sharedURL), 't139',
