<?php /* Smarty version 2.6.18, created on 2011-07-04 09:43:34
         compiled from cat/index.html */ ?>
...
/index/info">管理中心</a> </span><span id="search_id" class="action-span1"> - 类别列表</span>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">类别编号</span></div></td>
        <td width="32%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">类别名称</span></div></td>
        <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">商品数量</span></div></td>
        <td width="16%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">类别描述</span></div></td>
...
?>
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['c_name']; ?>
</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><!--这个地方是该类别的商品数量 --></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['c_desn']; ?>
</div></td>
