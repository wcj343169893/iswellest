<?php /* Smarty version 2.6.18, created on 2011-07-08 22:55:58
...
" <?php if ($this->_tpl_vars['data']['w_cat'] == $this->_tpl_vars['cat'][$this->_sections['ls']['index']]['c_name']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['cat'][$this->_sections['ls']['index']]['c_name']; ?>
</option>
							<?php endfor; endif; ?>
							-->
							</select>
...
"<?php if ($this->_tpl_vars['data']['w_brand'] == $this->_tpl_vars['brand'][$this->_sections['ls']['index']]['b_name']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['brand'][$this->_sections['ls']['index']]['b_name']; ?>
</option>
							<?php endfor; endif; ?>
								</select>
...
' size='27' /> <font color="red">*</font> </td>
		...
		<tr>
					 ...
					 <td> <input type='text' name='w_jf' maxlength="20" value='' size='27' /> <font color="red">*</font><br> 
					 购买该商品时最多可以使用多少钱的积分
					 </td>
		</tr>
		<tr>
