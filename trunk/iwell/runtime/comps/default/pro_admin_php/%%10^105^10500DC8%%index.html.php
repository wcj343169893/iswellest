<?php /* Smarty version 2.6.18, created on 2011-07-09 00:04:53
         compiled from content/index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'content/index.html', 75, false),)), $this); ?>
...
/index/info">管理中心</a> </span><span id="search_id" class="action-span1"> - 快报列表</span>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">快报编号</span></div></td>
        <td width="32%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">快报标题</span></div></td>
        <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">快报内容</span></div></td>
...
?>
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['title']; ?>
</div></td>
       
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['content']; ?>
</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['data'][$this->_sections['ls']['index']]['ntime'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y年 %m月 %d日") : smarty_modifier_date_format($_tmp, "%Y年 %m月 %d日")); ?>
</div></td>
