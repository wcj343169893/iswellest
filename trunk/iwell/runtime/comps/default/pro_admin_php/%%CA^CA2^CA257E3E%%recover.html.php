<?php /* Smarty version 2.6.18, created on 2011-07-09 00:04:36
         compiled from ware/recover.html */ ?>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="32%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">商品名称</span></div></td>
        <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">货号</span></div></td>
        <td width="26%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">价格</span></div></td>
...
?>
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['w_code']; ?>
</div></td>
		...
		<!-- 还原 将is_show的值在更改回去 --><a href="<?php echo $this->_tpl_vars['url']; ?>
/restore/id/<?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['id']; ?>
">还原</a>| 
		<!-- 删除 彻底删除调用DELETE--><a onclick="return confirm('您确定要删除该商品？删除后将不能恢复。');"href="<?php echo $this->_tpl_vars['url']; ?>
