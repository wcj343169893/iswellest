<?php /* Smarty version 2.6.18, created on 2012-04-14 12:55:41
...
<title>购物车-<?php echo $this->_tpl_vars['lan']['site_title']; ?>
</title>
...
function getCartInfo(){
	...
	{	
		...
		{
				//alert(arr);
				str+='<tr><td>'+arr[i][0]+'</td><td align="left" class="good_name_td"><a href="#"><img src="<?php echo $this->_tpl_vars['public']; ?>
...
" class="cart_button_0">继续购物</a><a href="<?php echo $this->_tpl_vars['app']; ?>
...
" width="150" height="150" alt="" class="block" /></a>
					...
					<p class="cf00">价格：<strong class="f14">￥<?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['w_price']; ?>
.00</strong></p>
