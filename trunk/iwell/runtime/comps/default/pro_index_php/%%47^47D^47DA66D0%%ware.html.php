<?php /* Smarty version 2.6.18, created on 2011-07-12 08:44:44
         compiled from search/ware.html */ ?>
...
</strong><a href="#"><img width="50" height="50" src="<?php echo $this->_tpl_vars['public']; ?>
/images/ware/<?php echo $this->_tpl_vars['data1'][$this->_sections['ls']['index']]['w_pic']; ?>
" alt="" class="fl"></a></p>
							<p><a href="#"><?php echo $this->_tpl_vars['data1'][$this->_sections['ls']['index']]['w_name']; ?>
</a></p>
							<p>商品描述商品描述商品描述商品描述商品描述商品</p><p><strong class="f14 cf00">￥<?php echo $this->_tpl_vars['data1'][$this->_sections['ls']['index']]['w_price']; ?>
.00</strong></p>
						</li>
				<?php endfor; endif; ?>
					</ol>
	...
	<div class="goods_list_right"> 
		...
		<!--频道导航 end--> 
		<!--搜索结果 start-->
		<p class="search_result_info"><?php echo $this->_tpl_vars['con']; ?>
