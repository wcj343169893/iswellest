<?php /* Smarty version 2.6.18, created on 2011-07-12 09:21:09
         compiled from index/listnews.html */ ?>
...
"><font color="red" size=2><b>首页</b></font></a> &gt; <a href="#">商城快报</a> &gt; <span>新闻标题</span></p>
	<div class="w960 mt_10">
		<div class="news_left">
...
/content/id/<?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['id']; ?>
...
/images/news/1.png" width="180" alt="" class="block" /></a></p>
		...
		<div class="news_right">
			<div class="news_lists">
				<div class="news_lists_tit">
					<select class="fr"><option>新闻</option></select><strong class="fl f14">商城快报</strong>
				</div>
				<ul class="news_lists_details">
				<?php unset($this->_sections['ls']);
$this->_sections['ls']['loop'] = is_array($_loop=$this->_tpl_vars['data']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['ls']['name'] = 'ls';
$this->_sections['ls']['show'] = true;
...
$this->_sections['ls']['last']       = ($this->_sections['ls']['iteration'] == $this->_sections['ls']['total']);
?>
					<li><span class="fl">【新闻】</span><a href="<?php echo $this->_tpl_vars['url']; ?>
/content/id/<?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['id']; ?>
" class="fl"><?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['title']; ?>
</a><span class="fr"><?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['ntime']; ?>
</span></li>
				<?php endfor; endif; ?>
				</ul>
