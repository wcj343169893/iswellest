<?php /* Smarty version 2.6.18, created on 2011-07-04 18:31:17
...
/images/index/demo/3.jpg" width="714" height="230" alt="" /></a></li>
	...
	<div class="col_right"> 
		<!--快报 start-->
		<dl class="bulletin_0">
			<dt><a href="新闻列表.html" class="fr">更多快报</a><strong class="f14 c502">商城快报</strong></dt>
...
/newslast.html"><?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['title']; ?>
</a></dd>
			<?php endfor; endif; ?>
		</dl>
		<!--快报 end-->
		<p class="index_ad_0"> <a href="#"><img src="images/index/demo/4.jpg" width="227" height="79" alt="" class="block" /></a> </p>
	</div>
</div>
<div class="w960 mt_10">
	<div class="col_left"> 
		...
		<div class="index_sort">
			...
			<dl>
				<dt><a href="#">手机/配件</a></dt>
				<dd><a href="#">GSM手机GSM手机GSM手机GSM手机GSM手机GSM手机</a></dd>
				<dd><a href="#">GSM手机GSM手机GSM手机GSM手机</a></dd>
				<dd><a href="#">GSM手机GSM手机GSM手机</a></dd>
				<dd><a href="#">GSM手机GSM手机</a></dd>
				<dd><a href="#">GSM手机</a></dd>
				<dd><a href="#">GSM手机</a></dd>
				<dd><a href="#">GSM手机</a></dd>
				<dd><a href="#">GSM手机</a></dd>
	...
	<div class="col_right"> 
		...
		<div class="index_group">
			...
			<a href="#"><img src="images/index/demo/5.jpg" width="150" height="150" alt="" /></a>
			<p class="p_0"><a href="#" class="cb00">商品名称</a></p>
			<p class="p_0 c666">商品描述商品描述商品描述商品描述</p>
			<div class="index_group_time"> <span class="span_0">离结束仅剩</span> <span class="span_1">62小时22分33秒</span> </div>
		</div>
		<!--今日团购 end--> 
	</div>
</div>
...
/images/index/demo/7.jpg" width="212" height="411" alt="" /></a> </div>
				<ul>
				<?php unset($this->_sections['ls']);
$this->_sections['ls']['loop'] = is_array($_loop=$this->_tpl_vars['data']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['ls']['name'] = 'ls';
...
/<?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['w_pic']; ?>
" width="150" height="150" alt="" /></a>
					  <p class="pro_name"><a href="#"><?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['w_name']; ?>
</a></p>
						<p class="cb00">普泰价：<strong class="f14"><?php echo $this->_tpl_vars['data'][$this->_sections['ls']['index']]['w_price']; ?>
</strong></p>
					</li>
					<?php endfor; endif; ?>
				</ul>
...
"><img  src="<?php echo $this->_tpl_vars['public']; ?>
/<?php echo $this->_tpl_vars['pj'][$this->_sections['pj']['index']]['w_pic']; ?>
" width="150" height="150" alt="" /></a>
						<p class="pro_name"><a href="#"><?php echo $this->_tpl_vars['pj'][$this->_sections['pj']['index']]['w_name']; ?>
</a></p>
						<p class="cb00">普泰价：<strong class="f14">￥<?php echo $this->_tpl_vars['pj'][$this->_sections['pj']['index']]['w_price']; ?>
</strong></p>
				  </li>
				<?php endfor; endif; ?>
				  </li>
...
?>
		<p class="index_ad_1 mt_10"><a href="#"><img src="<?php echo $this->_tpl_vars['public']; ?>
/<?php echo $this->_tpl_vars['r'][$this->_sections['r']['index']]['w_pic']; ?>
