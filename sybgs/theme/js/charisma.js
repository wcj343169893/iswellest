$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','theme/css/bootstrap-'+theme_name+'.css');
	}
...
function docReady(){
	...
	var elf = $('.file-manager').elfinder({
		url : 'theme/misc/elfinder-connector/connector.php'  // connector URL (REQUIRED)
	}).elfinder('instance');
	...
	$('#file_upload').uploadify({
		'swf'      : 'theme/misc/uploadify.swf',
		'uploader' : 'theme/misc/uploadify.php'
