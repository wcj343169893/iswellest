		...
		<footer>
			<p class="pull-left">&copy; <a href="#" target="_blank">北京林业大学</a> <?php echo date('Y') ?></p>
			<p class="pull-right">Powered by: <a href="#">马征</a></p>
		</footer>
		<?php } ?>
	...
	<!-- tour library -->
	<script src="theme/js/bootstrap-tour.js"></script>
	...
	<script src="theme/js/jquery.flot.pie.min.js"></script>
