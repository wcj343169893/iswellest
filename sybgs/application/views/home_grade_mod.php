...
<div class="form-horizontal">
	...
	<div class="control-group">
	  ...
	  <div class="control-group">
	      	...
	      	<div class="controls">
	      	  <input name="grade1" id="grade1" class="input-xlarge" type="text" value="<?php echo $score->score1?>" onChange="sum2()">
		...
		<div class="control-group">
	      	...
	      	<div class="controls">
	      	  <input name="grade2" id="grade2" class="input-xlarge" type="text" value="<?php echo $score->score2?>" onChange="sum2()">
		...
		<div class="control-group">
	      	...
	      	<div class="controls">
	      	  <input name="grade3" id="grade3" class="input-xlarge" type="text" value="<?php echo $score->score3?>" onChange="sum2()">
		...
		<div class="control-group">
	      	...
	      	<div class="controls">
	      	  <input name="grade4" id="grade4" class="input-xlarge" type="text" value="<?php echo $score->score4?>" onChange="sum2()">
		...
		<div class="control-group">
	      	...
	      	<div class="controls">
	      	  <input name="grade5" id="grade5" class="input-xlarge" type="text" value="<?php echo $score->score5?>" onChange="sum2()">
		...
		<div class="control-group">
	      	...
	      	<div class="controls">
	      	  <input name="grade7" id="grade7" class="input-xlarge" type="text" value="<?php echo $score->score7?>" onChange="sum2()">
		...
		<div class="control-group">
	      	...
	      	<div class="controls">
	      	  <input name="iswin" type="checkbox" value="1" id="iswin" <?php if($score->iswin){echo "checked";}?> >
	      ...
	      <div class="form-actions">
			...
			<button id="zlsub" type="submit" class="btn btn-primary">重新评分</button>
	    </div>
	<?php echo form_close() ?>
</div>
