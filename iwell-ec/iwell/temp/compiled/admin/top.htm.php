...
background: url("images/main_03.gif") repeat-x;
}
...
#menu-div {
  background: #80BDCB url("images/main_10.gif") repeat-x;
  font-weight: bold;
  height: 40px;
  line-height:36px;
}
...
?>
  ...
  <div id="load-div" style="padding: 10px 10px 0 0; text-align: right; color: #FF9900; float:right;"><img src="images/loading.gif" width="214" height="15" alt="<?php echo $this->_var['lang']['loading']; ?>" style="vertical-align: middle" /> &nbsp;</div>
  <br class="clear" />
</div>
</body>
</html>