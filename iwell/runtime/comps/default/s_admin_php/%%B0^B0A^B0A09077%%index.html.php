<?php /* Smarty version 2.6.18, created on 2011-07-04 09:59:44
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">详细描述</span></div></td>
...
?>
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><img src="<?php echo $this->_tpl_vars['res']; ?>
/images/icon_view.gif"> <img src="<?php echo $this->_tpl_vars['res']; ?>
/images/icon_edit.gif"> <img src="<?php echo $this->_tpl_vars['res']; ?>
/images/icon_trash.gif"></div></td>
      </tr>
	  <?php endfor; endif; ?>
    </table></td>
  </tr>
