 ...
 * By default
 * ErrorHandler::handleError() is used. It will display errors using Debugger,
 * when debug > 0
 ...
 * Make sure you add App::uses('MyHandler', 'Error'); when using a custom
 * handler class
 ...
 * By default,
 * ErrorHandler::handleException() is used. It will display a HTML page for the
 * exception, and
 ...
 * helpful if you deploy the same application via multiple subdomains and
 * languages,
 ...
 *
 * To define a custom session handler, save it at
 * /app/Model/Datasource/Session/<name>.php.
 * Make sure the class implements `CakeSessionHandlerInterface` and set
 ...
 *
 * Set to `true` to apply timestamps when debug > 0. Set to 'force' to always
 * enable
 ...
 * This requires a/var/cache directory to be writable by the web server for
 * caching.
 * and /vendors/csspp/csspp.php
 *
 * To use, prefix the CSS link URL with '/ccss/' instead of '/css/' or use
 * HtmlHelper::css().
 */
// Configure::write('Asset.filter.css', 'css.php');

/**
 * Plug in your own custom JavaScript compressor by dropping a script in your
 * webroot to handle the
 * output, and setting the config below to the name of the script.
 *
 * To use, prefix your JavaScript link URLs with '/cjs/' instead of '/js/' or
 * use JavaScriptHelper::link().
 */
 ...
 *
 * Note: 'default' and other application caches should be configured in
 * app/Config/bootstrap.php.
 * Please check the comments in boostrap.php for more info on the cache engines
 * available
 * and their settings.
 */
$engine = 'File';
...
Configure::write ( 'PAYPAL', array (
		'TEST' => 1,
		'WEBSITE' => "http://www.bluewatersseafood.com/",
