<div id="box">
   <h3>CookingClass</h3>
	...
	<?php if(!empty($cooking)){foreach($cooking as $k=>$v){?>
		<tr>
           <td><a href="/admin/cookingclass/view/<?php echo $v["Cooking"]["id"]?>"><?php echo $v["Cooking"]["name"]?></a></td>
           ...
           <td><a href="/admin/cookingclass/edit/<?php echo $v["Cooking"]["id"]?>">Edit</a></td>
       </tr>
      <?php }}?>
	</tbody>
</table>
<?php echo $this->element("paging",array("paging_url"=>"/admin/cookingclass"),array('plugin'=>"admin"));?>
</div>
